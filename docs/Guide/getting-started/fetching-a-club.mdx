...
Instead of using `club-tag` as your tag, you can also use `#club-tag` or `%23club-tag` to get the same result. For
example, `XYZ`, `#XYZ` and `%23XYZ` all return same club.
