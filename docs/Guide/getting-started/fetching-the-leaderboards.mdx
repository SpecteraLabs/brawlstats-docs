...
## Extra Info
The region must be either `'global'` or a two letter country name, corrently we don't offer typings for this but you can either use declaration merging like this:
```typescript
// augment.d.ts
